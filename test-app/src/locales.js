...
const es_translation = {
    ...
    "trace subscriptions and publications": "trazar suscripciones y publicaciones",
    "i18next debug output": "salida de depuración de i18next",
    "trace the messages to and from the backend": "trazar los mensajes con el backend",
    "trace the periodic timer event": "trazar el evento del temporizador periódico",
    ...
    /*  Asked by the raw-json viewer since gobj-ui 7.25.21 / 7.25.22  */
    "ok": "Aceptar",
...
const en_translation = {
    ...
    "expanded": "Expanded",
    "payload": "Payload",
    "traffic payload folded": "Traffic: payload folded",
    "traffic payload laid out": "Traffic: payload laid out",
    "show the payload of the traces": "Show the payload the traces dump (ev_kw, publications)",
    "window": "Window",
    "console": "Console",
    "both": "Both",
    ...
    "trace subscriptions and publications": "trace subscriptions and publications",
    "i18next debug output": "i18next debug output",
    "trace the messages to and from the backend": "trace the messages to and from the backend",
    "trace the periodic timer event": "trace the periodic timer event",
