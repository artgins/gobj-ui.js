...
const es_translation = {
    ...
    "Same depth as Meter 1, but this branch declares chrome_depth: 1, so only ONE chrome strip is painted instead of one per ancestor. How much chrome a corner of the tree deserves is a property of the tree, not of the renderer.": "La misma profundidad que Contador 1, pero esta rama declara chrome_depth: 1, así que sólo se pinta UNA tira de chrome en vez de una por ancestro. Cuánto chrome merece un rincón del árbol es una propiedad del árbol, no del pintor.",
