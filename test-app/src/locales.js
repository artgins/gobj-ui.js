...
const es_translation = {
    ...
    "The cards below are child NODES, each a gobj. Walk in: Energy → North hall → Meter 1 is four levels deep. This chapter shows the way in as STACKED TABS — one strip per ancestor. The buttons reshape the live tree; the last one switches this chapter to a breadcrumb.": "Las tarjetas de abajo son NODOS hijos, cada uno un gobj. Entra: Energía → Nave norte → Contador 1 son cuatro niveles. Este capítulo muestra el camino como PESTAÑAS APILADAS, una tira por ancestro. Los botones remodelan el árbol vivo; el último cambia este capítulo a miga de pan.",
